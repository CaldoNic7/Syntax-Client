  ...
  render () {
    ...
    return (
      <>
        ...
        <Card style={ goalCard }>
          <p style={ goalPara }> I want to type {characters} characters per minute in { language }, by { date }. I will achieve this goal by practicing { time } { measurement } every { frequency } </p>
          <Form style={ goalForm }onSubmit={this.handleSubmit}>
            <Form.Group controlId='name' style={nameGroup}>
              <Form.Control
                required
                name='name'
                value={name}
            ...
            <Form.Group controlId='language' style={ langGroup }>
            ...
            <Form.Group controlId='date' style={ dateGroup }>
              <Form.Control type="date" name="date" defaultValue={ date } onChange={this.handleChange}/>
            </Form.Group>
            <Form.Group controlId='time' style={ timeGroup }>
              <Form.Control type="number"
                className="form-control"
                name='time'
                defaultValue={ time }
